...
group_name=$1
group_role=$2 #Valid groups are "DEFAULT_APPROVER" "ADMIN" "ALERT_EMAIL_RECEIVER" "ALERTS_IGNORER" "LICENSE_AND_COPYRIGHT_ASSIGNER" "AUDITOR" "USER" "PRODUCT_INTEGRATOR"
